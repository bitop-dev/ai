...
This directory contains package-level docs for the Go AI SDK.
...
- [providerutils](providerutils.md): Tooling, schema/JSON helpers, HTTP/SSE utilities.
- [registry](registry.md): Provider registry and model resolution.
- [parity](parity.md): Feature coverage overview.
- [limitations](limitations.md): Known gaps and constraints.
...
- [Black Forest Labs](providers/black-forest-labs.md)
...
- [Provider template](providers/template.md)
